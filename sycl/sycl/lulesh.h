...
public: 
  ...
  sycl::event time_constraint_computed;
...
void CommSendGpu(Domain &domain, Int_t msgType, Index_t xferFields,
                 ...
                 bool doSend, bool planeOnly, sycl::queue *stream);
void CommSBNGpu(Domain &domain, Int_t xferFields, Domain_member *fieldData,
                sycl::queue **streams);
void CommSyncPosVelGpu(Domain &domain, sycl::queue **streams);
void CommMonoQGpu(Domain &domain, sycl::queue *stream);
